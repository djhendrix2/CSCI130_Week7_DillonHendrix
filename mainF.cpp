...
int main()
{
    ...
    do 
    {
        cout << "Determine the speed of a falling oject after an elapsed time (t)." << endl;
...
void time2Fall()
{
    ...
    cout << endl;
    cout << "The time it takes for an item to fall to the ground from the" << endl;
    cout << "top of the Empire State Building is " << t_fall << " seconds." << endl;
